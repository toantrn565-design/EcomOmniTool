...
class ShopeeVideoUploader:
    def __init__(self, profile_dir: str = "shopee_profile"):
        if os.path.isabs(profile_dir):
            ...
            poster_profile = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "ShopeeVideoAutoPoster", profile_dir))
            if os.path.exists(poster_profile):
                self.profile_dir = poster_profile
            else:
